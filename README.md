...
Aegis Atlas is a deployable disaster-intelligence research program founded by **Viren Singh**. It includes a login screen, world risk map, humidity and response-readiness layers, automated summaries, downloadable reports, data export, scenario simulation, and transparent risk-model notes.
...
- Cyber Intelligence Lab with Investigator, Analyst, Threat, and Research agents
- Local vector database, hashed embeddings, document retrieval, and short-term agent memory
- Custom synthetic dataset for phishing URLs, malware behavior logs, AI-generated attack simulations, misinformation graphs, defense memory, and benchmark notes
- Cyber attack simulation engine with fictional attack chains, network maps, breach timelines, threat propagation, AI responses, and lockdown states
- Autonomous AI Threat Globe with real-time 3D cyber intelligence visualization, simulated global attack arcs, AI response arcs, autonomy control, and threat pulse injection
...
This project is a simulation and educational decision-support interface. It is not a substitute for official emergency alerts, government agencies, meteorological departments, or humanitarian command systems.
