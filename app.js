...
function drawThreatGlobe() {
  ...
  $("#globeReadout").innerHTML = `<strong>Autonomous AI Threat Globe</strong><br>${globeThreats.length} simulated global threat streams tracked. Fusion confidence ${fused}%. Mode: ${mode}. ${lockdownActive ? "Defense lockdown is active." : "Agents are monitoring and preparing response arcs."}`;
  ctx.fillStyle = "#edf6ff";
  ctx.font = "20px Inter, sans-serif";
  ctx.fillText("Autonomous AI Threat Globe", 28, 38);
  ctx.fillStyle = "#9fb8d8";
  ctx.font = "13px Inter, sans-serif";
...
function injectThreatPulse() {
  ...
  globePulse = 18;
  remember("threat", "Injected new synthetic global threat pulse");
